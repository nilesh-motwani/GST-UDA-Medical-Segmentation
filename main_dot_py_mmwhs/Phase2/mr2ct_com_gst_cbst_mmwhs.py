...
# ==============================================================================
# 1. PHASE 2 GST CONFIGURATION (MR -> CT)
# ==============================================================================
CONFIG = {
    ...
    # 🌟 LOAD PHASE 1 WEIGHTS: Warm start from the 73.85% peak!
    'PRETRAINED_SEGMENTOR': r'D:\Nilesh\GST-UDA\MMWHS\SIFA_FDA_CBST_MR2CT\best_SIFA_FDA_Segmentor_MR2CT.pth',
    'SAVE_DIR': r'D:\Nilesh\GST-UDA\MMWHS\GST_PHASE2_MR2CT', 
    ...
    'FDA_BETA': 0.05,
    'CONFIDENCE_THRESH': 0.85   # Strict CT Threshold
}
...
# ==============================================================================
# 9. MAIN EXECUTION (MR -> CT Phase 2)
# ==============================================================================
if __name__ == '__main__':
    print(f"\n--- Initializing PHASE 2 GST + FDA + Mean Teacher (MR -> CT) ---")
    ...
    for epoch in range(CONFIG['EPOCHS']):
        ...
        for batch_idx, (s_img, s_img_fda, s_mask, s_edge, s_body, t_img) in enumerate(tqdm(train_loader, leave=False, desc=f"Epoch {epoch+1}")):
            ...
            # 🌟 MEAN TEACHER + GST LOGIC ON REAL TARGET (CT)
            with torch.no_grad():
    ...
    print("\n" + "="*60)
    print("🚀 FINAL ZERO-SHOT TEST RESULTS (SIFA + FDA + GST: MR -> CT)")
    print("="*60)
