...
# ==============================================================================
CONFIG = {
    'IMG_DIR': r'D:\Nilesh\GST-UDA\MMWHS\MMWHS_Data_2D\Images\CT',
    'MASK_DIR': r'D:\Nilesh\GST-UDA\MMWHS\MMWHS_Data_2D\Masks\CT',
    'SAVE_DIR': r'D:\Nilesh\GST-UDA\MMWHS\DBSNet_CT_Baseline', 
    'EPOCHS': 200,     
    'BATCH_SIZE': 32,  
    'LR': 3e-4,
    'NUM_WORKERS': 4,
...
def calculate_full_3d_metrics(model, dataset, device):
    ...
    with torch.no_grad():
        for i in tqdm(range(len(dataset))):
            ...
            # Assumes format MMWHS_CT_1001_slice001.npy
...
class BioMedicalValidator:
    ...
    def plot_spectral_proof(self, sample_img_tensor):
        ...
        print("✅ Spectral Proof Generated.")
...
if __name__ == '__main__':
    ...
    print(f"\n--- Initializing FULL CT Pipeline for MMWHS ---")
    ...
    for epoch in range(CONFIG['EPOCHS']):
        ...
        if current_dice > best_dice:
            ...
            save_path = os.path.join(CONFIG['SAVE_DIR'], f"best_model_MMWHS_CT.pth")
    ...
    model.load_state_dict(torch.load(os.path.join(CONFIG['SAVE_DIR'], f"best_model_MMWHS_CT.pth"), weights_only=True))
    ...
    plt.title("CT Training Curves")
    plt.savefig(f"{CONFIG['SAVE_DIR']}/Proof_Training_Curves_CT.png")
